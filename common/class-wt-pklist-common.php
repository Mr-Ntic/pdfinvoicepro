 ...
 * @subpackage Wt_woocommerce_invoice_addon/common
 */

if(!class_exists('Wt_Pklist_Common_Ipc'))
{
class Wt_Pklist_Common_Ipc
{
    /**
    ...
    public static function get_instance($plugin_name, $version)
    {
        ...
        {
            self::$instance=new Wt_Pklist_Common_Ipc($plugin_name, $version);
        }
    ...
    {    
        ...
        // if meta_value is still emptuy then try prefixed with underscore (not when ACF is active!)
