...
<div class="wfte_rtl_main wfte_invoice-main wfte_adc_main">
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-bottom:20px;">
        ...
        <div class="wfte_col-6 float_right">
            <div class="wfte_invoice_data wfte_template_element" data-hover-id="invoice_number" style="text-align:right;">
                <div class="wfte_invoice_number"> <span class="wfte_invoice_number_label">__[INVOICE]__#</span> <span class="wfte_invoice_number_val">[wfte_invoice_number] </span></div>
            </div>
        </div> 
    </div> 
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-bottom:20px;">                             
        ...
        <div class="wfte_col-6 float_right wfte_template_element" data-hover-id="qrcode">
            <div class="wfte_qrcode float_right wfte_text_right">
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-bottom:20px;"> 
        ...
        <div class="wfte_col-3 float_right">
            <div class="wfte_invoice_data" style="text-align:right;">
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-top:20px;"> 
        ...
        <div class="wfte_col-4 float_right">
            <div class="wfte_signature wfte_text_right wfte_template_element" data-hover-id="signature">
