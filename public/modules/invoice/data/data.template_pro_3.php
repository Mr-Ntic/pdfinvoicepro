...
.wfte_product_table_body td{ padding:15px 5px 5px 5px; border-bottom:solid 1px #cccccc; text-align:start; vertical-align: top;}
...
<div class="wfte_rtl_main wfte_invoice-main wfte_adc_main"> 
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-bottom:20px;">       
        <div class="wfte_col-6 float_left">
            <div class="wfte_doc_title wfte_template_element" data-hover-id="doc_title" style="text-align:left;">__[INVOICE]__</div>
        </div>
        ...
        <div class="wfte_col-3 float_right">           
            <div class="wfte_invoice_data" style="text-align:right;">
                ...
                <div class="wfte_ssn_number wfte_template_element" data-hover-id="ssn_number">
                    ...
                    <span class="wfte_ssn_number_label">[wfte_ssn_number]</span>
                </div>
