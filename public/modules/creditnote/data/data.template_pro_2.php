<?php
    ...
    if(class_exists('Wf_Woocommerce_Packing_List_Template_Load')){
        $all_attr = Wf_Woocommerce_Packing_List_Template_Load::load_template_element_attributes('creditnote');
    }
?>
<!-- DC ready -->
<style type="text/css">
...
.wfte_hr{ height:1px; font-size:0px; padding:0px; background:#cccccc; margin: 20px 0px;}

.wfte_company_logo_img_box{ margin-bottom:10px; }
.wfte_company_logo_img{ width:150px; max-width:100%; }
.wfte_doc_title{ color:#333; font-size:30px; font-weight:bold; height:auto; width:100%; line-height:22px;}
...
.wfte_return_policy{width:100%; height:auto; padding:5px 0px; margin-top:5px; margin-bottom: 10px;}
...
.wfte_product_table_head_bg{ color:#ffffff; }
</style>
<div class="wfte_rtl_main wfte_invoice-main wfte_adc_main"> 
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix">       
        <div class="wfte_col-1 float_left">
            <div class="wfte_doc_title wfte_template_element" data-hover-id="doc_title" style="text-align:right;">__[Credit note]__</div>
        </div>
    </div>
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix">       
        ...
        <div class="wfte_col-6 float_right">
            <div class="wfte_invoice_data" style="background-color: #f3f3f3;padding:10px">
    ...
    <div class="clearfix"></div>
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix">
        <div class="wfte_col-6 float_left wfte_text_left">
            <div class="wfte_from_address wfte_template_element" data-hover-id="from_address">
                ...
                <div class="wfte_from_address_val">
                    ...
                    <span class="wfte_from_address_country">[wfte_from_address_country]</span> <br />
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix">
        ...
        <div class="wfte_col-6 float_left wfte_text_left">
            <div class="wfte_shipping_address wfte_template_element" data-hover-id="shipping_address">
                <div class="wfte_address-field-header wfte_shipping_address_label" style="padding-left: 25px;">__[Shipping Address:]__</div>
                <div class="wfte_shipping_address_val" style="padding-left: 25px;">
                    ...
                    <span class="wfte_shipping_address_phone">[wfte_shipping_address_phone]<br /></span>
                </div>
            </div>
        </div>
        <div class="wfte_col-6 float_right wfte_text_left">          
            <div class="wfte_invoice_data" style="background-color: #f3f3f3;padding:10px">
                <div class="wfte_creditnote_number wfte_template_element" data-hover-id="creditnote_number">
                    <span class="wfte_creditnote_number_label">__[Credit note No:]__</span>
                    <span class="wfte_creditnote_number_val">[wfte_creditnote_number]</span>
                </div>
                <div class="wfte_creditnote_date wfte_template_element" data-creditnote_date-format="m-d-Y" data-hover-id="creditnote_date">
                    <span class="wfte_creditnote_date_label">__[Credit note Date:]__</span>
                    <span class="wfte_creditnote_date_val">[wfte_creditnote_date]</span>
                </div>
        ...
        <div class="wfte_col-1">
            ...
            <table class="wfte_product_table wfte_side_padding_table wfte_template_element" data-hover-id="product_table">
                <thead class="wfte_product_table_head wfte_table_head_color wfte_product_table_head_bg">
                    <tr>
                        <th class="wfte_product_table_head_serial_no wfte_product_table_head_bg wfte_table_head_color" col-type="serial_no" data-col-value-font-size="12px" data-col-value-font-weight="normal">__[S.No]__</th>
                        ...
                        <th class="wfte_product_table_head_price wfte_product_table_head_bg wfte_table_head_color" col-type="price" data-col-value-font-size="12px" data-col-value-font-weight="normal" data-tax-type="<?php esc_attr_e($all_attr['tax_type']); ?>" data-discount-type="after_discount">__[Price]__</th>
                        <th class="wfte_product_table_head_total_price wfte_product_table_head_bg wfte_table_head_color" col-type="total_price" data-col-value-font-size="12px" data-col-value-font-weight="normal" data-tax-type="<?php esc_attr_e($all_attr['tax_type']); ?>" data-discount-type="after_discount">__[Total price]__</th>
                        <th class="wfte_product_table_head_tax_items wfte_product_table_head_bg wfte_table_head_color" col-type="tax_items" data-ind-tax-display-option="amount" data-col-value-font-size="12px" data-col-value-font-weight="normal" data-discount-type="after_discount">[wfte_product_table_tax_item_column_label]</th>
                        <th class="wfte_product_table_head_tax wfte_product_table_head_bg wfte_table_head_color" col-type="tax" data-total-tax-display-option="amount" data-col-value-font-size="12px" data-col-value-font-weight="normal" data-discount-type="after_discount" >__[Total tax]__</th>
                    </tr>
                </thead>
            ...
            <table class="wfte_payment_summary_table wfte_product_table wfte_side_padding_table">
                <tbody class="wfte_payment_summary_table_body wfte_table_body_color">
                    ...
                    <tr data-row-type="wfte_refund_items" class="wfte_payment_summary_table_row wfte_product_table_refund_item wfte_template_element" data-hover-id="product_table_refund_item">
                        <td colspan="2" class="wfte_product_table_refund_item_label wfte_text_right">[wfte_product_table_refund_item_label]</td>
                        <td class="wfte_right_column">[wfte_product_table_refund_item]</td>
                    </tr>
                    <tr class="wfte_payment_summary_table_row wfte_product_table_payment_total wfte_template_element" data-hover-id="product_table_payment_total" data-row-type="wfte_product_table_payment_total" data-tax-type="<?php esc_attr_e($all_attr['tax_type']); ?>">
                        <td class="wfte_left_column wfte_product_table_head_bg" style="background-color: #212529;color:#fff;"></td>
                        <td class="wfte_product_table_payment_total_label wfte_product_table_head_bg wfte_text_right" style="background-color: #212529;color:#fff;">__[Total]__</td>
                        <td class="wfte_product_table_payment_total_val wfte_product_table_head_bg wfte_right_column wfte_text_left" style="background-color: #212529;color:#fff;">[wfte_product_table_payment_total]</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="clearfix"></div>
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-top: 15px;">
        <div class="wfte_col-1 float_left wfte_text_left">
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix">
        <div class="wfte_col-1">
            <div class="wfte_return_address wfte_template_element" data-hover-id="return_address">
...
<div class="wfte_padding_left_right wfte_adc_template_footer template_footer clearfix">
    <div class="wfte_col-1">
